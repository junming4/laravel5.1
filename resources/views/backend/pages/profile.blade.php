                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            ...
                            <a class="dropdown-toggle" data-toggle="dropdown" href="{{ route('admin.pages.profile') }}">
                                <i class="fa fa-wrench"></i>
                            </a>
                            <ul class="dropdown-menu dropdown-user">
                                <li><a href="{{ route('admin.pages.profile') }}">选项1</a>
                                </li>
                                <li><a href="{{ route('admin.pages.profile') }}">选项2</a>
                                </li>
                            </ul>
                            <a class="close-link">
                        ...
                        <div>
                            <div class="feed-activity-list">
                                ...
                                <div class="feed-element">
                                    <a href="{{ route('admin.pages.profile') }}" class="pull-left">

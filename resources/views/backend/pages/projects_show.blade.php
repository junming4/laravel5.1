    ...
    <div class="row">
                ...
                <div class="ibox">
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="m-b-md">
                                    <a href="{{ route('admin.pages.projects.show') }}#" class="btn btn-white btn-xs pull-right">编辑项目</a>
                                    <h2>阿里巴巴集团</h2>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-5">
                                <dl class="dl-horizontal">
                                    ...
                                    <dd>162</dd>
                                    <dt>客户：</dt>
                                    <dd><a href="{{ route('admin.pages.projects.show') }}#" class="text-navy"> 百度</a>
                                    </dd>
                                    <dt>版本：</dt>
                                    <dd>v1.4.2</dd>
                                </dl>
                            ...
                            <div class="col-sm-7" id="cluster_info">
                                <dl class="dl-horizontal">
                                    ...
                                    <dd class="project-people">
                                        <a href="{{ route('admin.pages.projects.show') }}">
                                    ...
                                    <div class="panel-heading">
                                        <div class="panel-options">
                                            <ul class="nav nav-tabs">
                                                <li><a href="{{ route('admin.pages.projects.show') }}#tab-1" data-toggle="tab">团队消息</a>
                                                </li>
                                                <li class=""><a href="{{ route('admin.pages.projects.show') }}#tab-2" data-toggle="tab">最后更新</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
        ...
        <div class="col-sm-3">
            <div class="wrapper wrapper-content project-manager">
                <h4>项目描述</h4>
                <img src="{{ asset('img/wenku_logo.png') }}" class="img-responsive">
                <p class="small">
                ...
                <ul class="tag-list" style="padding: 0">
                    <li><a href="{{ route('admin.pages.projects.show') }}"><i class="fa fa-tag"></i> 文档</a>
                    </li>
                    <li><a href="{{ route('admin.pages.projects.show') }}"><i class="fa fa-tag"></i> 分享</a>
                    </li>
                    <li><a href="{{ route('admin.pages.projects.show') }}"><i class="fa fa-tag"></i> 下载</a>
                    </li>
                </ul>
                <h5>项目文档</h5>
                <ul class="list-unstyled project-files">
                    <li><a href="{{ route('admin.pages.projects.show') }}"><i class="fa fa-file"></i> Project_document.docx</a>
                    </li>
                    <li><a href="{{ route('admin.pages.projects.show') }}"><i class="fa fa-file-picture-o"></i> Logo_zender_company.jpg') }}</a>
                    </li>
                    <li><a href="{{ route('admin.pages.projects.show') }}"><i class="fa fa-stack-exchange"></i> Email_from_Alex.mln</a>
                    </li>
                    <li><a href="{{ route('admin.pages.projects.show') }}"><i class="fa fa-file"></i> Contract_20_11_2014.docx</a>
                    </li>
                </ul>
                <div class="m-t-md">
                    <a href="{{ route('admin.pages.projects.show') }}#" class="btn btn-xs btn-primary">添加文档</a>

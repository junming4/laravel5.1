        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="contact-box">
                    <a href="{{ route('admin.pages.profile') }}">
                        <div class="col-sm-4">
            ...
            <div class="col-sm-4">
                <div class="contact-box">
                    <a href="{{ route('admin.pages.profile') }}">
                        <div class="col-sm-4">
                            <div class="text-center">
                                <img alt="image" class="img-circle m-t-xs img-responsive" src="{{ asset('img/a4.jpg') }}">
            ...
            <div class="col-sm-4">
                <div class="contact-box">
                    <a href="{{ route('admin.pages.profile') }}">
                        <div class="col-sm-4">
                            <div class="text-center">
                                <img alt="image" class="img-circle m-t-xs img-responsive" src="{{ asset('img/a5.jpg') }}">
            ...
            <div class="col-sm-4">
                <div class="contact-box">
                    <a href="{{ route('admin.pages.profile') }}">
                        <div class="col-sm-4">
                            <div class="text-center">
                                <img alt="image" class="img-circle m-t-xs img-responsive" src="{{ asset('img/a6.jpg') }}">
                                <div class="m-t-xs font-bold">射鸡师</div>
                            </div>
                        </div>
                        <div class="col-sm-8">
